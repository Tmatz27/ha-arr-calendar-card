...
git switch main
git pull --ff-only origin main
git tag -a v0.4.5 -m "Arr Calendar Card v0.4.5"
...
verify that **Releases** shows `v0.4.5` and that the JavaScript file is attached.
...
1. In HACS, open **Arr Calendar Card** and select **Update** to `v0.4.5`.
...
3. In the browser developer console, confirm the card banner reports `v0.4.5`.
